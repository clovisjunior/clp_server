<div class="widget-head">
	<h4 class="heading glyphicons cogwheels">
		<i></i>Ocorrências Fechadas
	</h4>
</div>
<div class="widget-body">
	<ul>
		<g:each in="${ocorrenciasFechadas}" var="unidade">
			<li>
							    ...
							    <g:each in="${maquina.alarmes}" var="alarme">
									<li>
									    ...
									    <span style="float: right; font-size: 15pt;"> 
									        ${alarme.ocorrencias?.findAll{it.estado == com.projeto.clp.type.EstadoOcorrenciaType.FECHADO}.size()}
									    </span>
									</li>			
								</g:each>
								</ol>
