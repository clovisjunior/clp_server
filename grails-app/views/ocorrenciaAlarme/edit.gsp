...
<html>
	...
	<body>
		...
		<div class="innerLR">
			...
			<g:hasErrors bean="${ocorrenciaAlarmeInstance}">
				<div class="alert alert-error">
					<g:eachError bean="${ocorrenciaAlarmeInstance}" var="error">
						<button type="button" class="close" data-dismiss="alert">&times;</button>
			...
			<g:form url="[resource:ocorrenciaAlarmeInstance, action:'update']" method="PUT"  class="form-horizontal" style="margin-bottom: 0;">
				<g:hiddenField name="version" value="${ocorrenciaAlarmeInstance?.version}" />
