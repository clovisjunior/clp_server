			...
			<table class="table table-bordered table-condensed table-striped table-vertical-center checkboxs js-table-sortable">
				<thead >
					<tr>
						...
						<g:sortableColumn property="offset" title="${message(code: 'registradorEscravo.offset.label', default: 'Offset')}" />
				...
				<g:each in="${registradorEscravoInstanceList}" status="i" var="registradorEscravoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: registradorEscravoInstance, field: "offset")}</td>
