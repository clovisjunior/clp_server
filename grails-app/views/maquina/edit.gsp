...
<html>
	...
	<body>
		<a href="#edit-maquina" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-maquina" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:maquinaInstance, action:'update']" method="PUT" >
