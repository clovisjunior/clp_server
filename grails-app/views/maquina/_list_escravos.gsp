	...
	<tbody>
		<g:each in="${escravoMaquinaList}" status="i" var="escravoMaquinaInstance">
			<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
				...
				<td><g:field type="text" name="identificador${escravoMaquinaInstance?.escravoId}" value="" placeholder="Identificador"/></td>
			
				<td><g:field type="text" name="descricao${escravoMaquinaInstance?.escravoId}" value="" placeholder="Descrição"/></td>
