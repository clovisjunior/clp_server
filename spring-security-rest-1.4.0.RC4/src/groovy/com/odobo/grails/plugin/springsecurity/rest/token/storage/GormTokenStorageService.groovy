...
class GormTokenStorageService implements TokenStorageService, GrailsApplicationAware {
    ...
    Object loadUserByToken(String tokenValue) throws TokenNotFoundException {
        ...
        if (existingToken) {
			...
			UsuarioMovel usuario = UsuarioMovel.findByUsuario(existingToken.usuarioMovel)
			
			def userDetails = new GrailsUser(usuario.usuario, usuario.senha, true, true, true, true, [roleUser], usuario)
        	return userDetails
		}
